            ...
            <View
              ...
              <View style={{ flex: 1, flexDirection: 'row' }}>
                ...
                <View
                  style={[
                    style,
                    {
                      ...
                      paddingVertical: 1,
                      position: 'absolute',
                      top: isFocusedState || value !== '' ? -11 : '39%',
                      // top: isFocusedState || value !== '' ? -11 : 18,
                      backgroundColor: '#fff',
                      alignItems: kurrency ? 'flex-end' : 'flex-start'
                      // backgroundColor: 'red',
                    },
                    !kurrency && { left: -4 },
                    kurrency &&
                    ...
                    style={[
                      {
                        ...
                        fontWeight: '400',
                        fontSize:
                          isFocusedState || value !== '' ? gsw(12) : gsw(16),
                        color: error
                          ? colors.red100
                          : isFocusedState
                            ? colors.momoBlue
                        ...
                        alignItems: 'center',
                        marginTop: isFocusedState || value !== '' ? gpsh('0') : gpsh('-5.5')
                      },
                    ]}>
                    {label}
                    {required && ' *'}
                ...
                <TextInput
                  ...
                  style={[input, {
                    justifyContent: 'flex-start', color: error
                      ? colors.red100
                      : isFocusedState
                        ? colors.black
                        : '#000'
